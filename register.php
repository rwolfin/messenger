...
if (isset($_POST["register"])) 
{
	...
	$mailer = new SendMailSmtpClass( "telefragged1@gmail.com", "fenumghpyukpigpi", "ssl://smtp.gmail.com", "SFMessenger", 465 );
    $headers = "MIME-Version: 1.0\r\n";
    $headers .= "Content-type: text/html; charset=utf-8\r\n";
    $headers .= "From: SFMessenger <telefragged1@gmail.com>\r\n";
    ...
    else
    {
        if ($user_object->save_data()) 
        {
            ...
            */
			...
			$mailer->send( $user_object->getUserEmail(), "Подтверждение", "<a href=\"http://localhost/verify.php?code=".$user_object->getUserVerificationCode()."\">Нажмите, чтобы подтвердить почту</a>", $headers );
